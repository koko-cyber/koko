...
function go(_0x4ed943) {
  function _0x4042a2() {
    var _0x42fd71 = window["navigator"]["userAgent"],
        _0x1cf48b = ["Phantom"];

    for (var _0x581403 = 0; _0x581403 < _0x1cf48b["length"]; _0x581403++) {
      if (_0x42fd71["indexOf"](_0x1cf48b[_0x581403]) != -1) {
        return true;
      }
    }
  ...
  if (_0x3958b2) {
    ...
    if (_0x4ed943['wt']) {
      _0xcdbd67 = parseInt(_0x4ed943['wt']) > _0x3958b2[1] ? parseInt(_0x4ed943['wt']) - _0x3958b2[1] : 500;
    } else {
      _0xcdbd67 = 1500;
    }

    setTimeout(function () {
      document["cookie"] = _0x4ed943['tn'] + '=' + _0x3958b2[0] + ";Max-age=" + _0x4ed943['vt'] + "; path = /";
