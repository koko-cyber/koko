...
function go(_0x45f37e) {
  function _0x5ba73e() {
    var _0x2a0b19 = window["navigator"]["userAgent"],
        _0x3cd030 = ["Phantom"];

    for (var _0x349522 = 0; _0x349522 < _0x3cd030["length"]; _0x349522++) {
      if (_0x2a0b19["indexOf"](_0x3cd030[_0x349522]) != -1) {
        return true;
      }
    }
  ...
  if (_0x1ec7b1) {
    ...
    if (_0x45f37e['wt']) {
      _0x25f0a5 = parseInt(_0x45f37e['wt']) > _0x1ec7b1[1] ? parseInt(_0x45f37e['wt']) - _0x1ec7b1[1] : 500;
    } else {
      _0x25f0a5 = 1500;
    }

    setTimeout(function () {
      document["cookie"] = _0x45f37e['tn'] + '=' + _0x1ec7b1[0] + ";Max-age=" + _0x45f37e['vt'] + "; path = /";
